...
//extern void ros_init_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen);
//extern ros_data ros_run_detector(IplImage *disp);
